        ...
        <div className='navbar2'>
            <ul className='navbar2-right'>
                <li className='navbar2-items'>
                    <button type='button' onClick={() => handleNavigation('Home')} aria-label='Go to home section'>
                ...
                <li className='navbar2-items'>
                    <button type='button' onClick={() => handleNavigation('AboutMe')} aria-label='Go to about section'>
                ...
                <li className='navbar2-items'>
                    <button type='button' onClick={() => handleNavigation('WorkAt')} aria-label='Go to work section'>
                ...
                <li className='navbar2-items'>
                    <button type='button' onClick={() => handleNavigation('Contact')} aria-label='Go to contact section'>
